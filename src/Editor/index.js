...
class WysiwygEditor extends Component {
  ...
  render() {
    ...
    const toolbar_order1 = ["fontFamily", "fontSize"];
    const toolbar_order2 = [
      "inline",
      "list",
      "textAlign",
      "link",
        ...
        {!toolbarHidden && (
          ...
          >
            {toolbar.options.map((opt, index) => {
              ...
              return <Control key={opt} {...controlProps} config={config} />;
            })}
            {toolbarCustomButtons &&
